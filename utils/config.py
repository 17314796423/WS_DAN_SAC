...
def getConfig():
    ...
    parser.add_argument('--feature-extract', metavar="feature_extract", default=False, type=bool,
                        help='stop grad update from bap')
    ...
    parser.add_argument('--prefix', default='', type=str, metavar='PATH',
                        help='path to base dir (default: none)')
    parser.add_argument('--resume-bap', default='', type=str, metavar='PATH',
                        help='path to latest checkpoint bap (default: none)')
